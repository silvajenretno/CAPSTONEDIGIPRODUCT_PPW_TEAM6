    ...
    <header>
      ...
      <div class="hero">
        <div class="hero-slide">
          <div
            class="img overlay"
            style="background-image: url('images/hero_bg_3.jpeg')">
          </div>
          <div
            class="img overlay"
        ...
        <div class="container">
          <div class="row justify-content-center align-items-center">
            <div class="col-lg-9 text-center">
              <h1 class="heading" data-aos="fade-up">Coffee That Inspires</h1>
            </div>
          </div>
        </div>
      </div>
...
.intro_video_icon::before {
  ...
  border-color: transparent transparent transparent #fff; /* warna tanda play */
...
.intro_video_icon::after {
  ...
  background-color: #fff; /* warna lingkaran */
  border-radius: 50%; /* lingkaran */
  animation: move 2s infinite alternate; /* animasi gerak bolak-balik */
} }
...
.main-title {
  margin-top: 10rem;
                ...
                <div class="col-xl-5 col-lg-5">
                    <div class="about_info">
                        <div class="section_title mb-20px">
                            ...
                            <h3 data-aos="fade-up">Starbucks Coffee</h3>
                        </div>
                        <p data-aos="fade-up">
                        Starbucks has evolved from a simple coffee shop into an inspiring community space. With a commitment to coffee quality, passion and compassion, Starbucks offers not just drinks, but meaningful experiences for everyone.
                        </p>
    ...
    <a id="play-video_1" class="video-play-button popup-youtube" href="https://youtu.be/H93jvfEnwUA?si=qRKVoLWCzjz5TZfI" target="_blank">
        <img src="./images/video.jpg" alt="Play Video" class="img-video">
    </a>
</div>
</div>
        ...
        <div class="row d-flex justify-content-center">
            <div class="menu-content pb-60 col-lg-10">
                <div class="title text-center">
                    <h3 class="mb-10 main-title"> Exclusive Deals Await!</h3>
...
<style>
  ...
  .maps {
    ...
    border: 2px solid #00704A; /* Warna hijau Starbucks */
    border-radius: 5px; /* Sudut border membulat */
    overflow: hidden; /* Menghilangkan border yang muncul di dalam frame */
  }
...
<section>
  <div class="container maps">
    ...
    <iframe  
    class="frame-maps"
      src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3989.6796876968683!2d117.14920967453727!3d-0.4776338352760237!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2df67fb29d38221b%3A0x9a12029ef74c44ad!2sStarbucks%20Coffee%20S.%20Parman!5e0!3m2!1sid!2sid!4v1715192658566!5m2!1sid!2sid" 
